...
Pod::Spec.new do |s|
  s.name             = 'BadasSwift'
  s.version          = '0.1.0'
  s.summary          = 'A colourful library of Swift base classes extensions.'
  s.swift_version    = '4.0'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
  A colourful library of Swift base classes extensions.
  Including :
  - NSLayoutConstraint
  - NSNumber
  - NSString
  ...
  s.source_files = 'BadasSwift/Classes/**/*'
  
  # s.resource_bundles = {
  #   'BadasSwift' => ['BadasSwift/Assets/*.png']
  # }
